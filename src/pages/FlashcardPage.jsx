...
export const FlashcardPage = () => {
  const { loading, currentCard, currentIndex, numCards, goNext, goPrevious } =
    useFlashcardContext();
  ...
  return (
    <Stack spacing={2} paddingTop={5} alignItems='center'>
      ...
      >
        ...
        <HideableComponent visible={currentIndex < numCards ? true : false}>
          <Typography>{`${currentIndex + 1} / ${numCards}`}</Typography>
        </HideableComponent>
